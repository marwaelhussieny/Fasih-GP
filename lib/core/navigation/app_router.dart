...
import 'package:grad_project/features/auth/presentation/screens/new_password_screen.dart';
import 'package:grad_project/features/home/presentation/screens/home_screen.dart';
import 'package:grad_project/features/wordle/presentation/screens/wordle_screen.dart';
...
import 'package:grad_project/features/grammar/presentation/screens/poetry_meter_screen.dart';
import 'package:grad_project/features/library/presentation/screens/library_screen.dart';
// Home feature screens
import 'package:grad_project/features/home/presentation/screens/lesson_details_screen.dart';
import 'package:grad_project/features/home/presentation/screens/video_lesson_screen.dart';
import 'package:grad_project/features/home/presentation/screens/level_completion_screen.dart';
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case AppRoutes.onboarding:
        return MaterialPageRoute(builder: (_) => const Text('Onboarding Screen'));
      ...
      case AppRoutes.newPassword:
        ...
        return MaterialPageRoute(builder: (_) => NewPasswordScreen(resetToken: resetToken));
      case AppRoutes.home:
        return MaterialPageRoute(builder: (_) => const HomeScreen());
      case AppRoutes.wordle:
        final args = settings.arguments as Map<String, dynamic>?;
        final isDaily = args?['isDailyWordle'] as bool? ?? true;
        return MaterialPageRoute(builder: (_) => WordleScreen(isDailyWordle: isDaily));
      case AppRoutes.dailyWordle:
        return MaterialPageRoute(builder: (_) => const WordleScreen(isDailyWordle: true));
      case AppRoutes.randomWordle:
        return MaterialPageRoute(builder: (_) => const WordleScreen(isDailyWordle: false));
      ...
      case AppRoutes.quiz:
        ...
        return MaterialPageRoute(builder: (context) => _errorRoute(context, 'Error: Quiz ID not provided.'));
      ...
      case AppRoutes.community:
        return MaterialPageRoute(builder: (_) => const CommunityMainScreen());
      ...
      case AppRoutes.morphology:
        return MaterialPageRoute(builder: (_) => const GrammarMorphologyScreen());
      ...
      case AppRoutes.poetryMeter:
        return MaterialPageRoute(builder: (_) => const PoetryMeterScreen());
    ...
    // Home feature routes
      case AppRoutes.lessonDetails:
        ...
        return MaterialPageRoute(
          builder: (context) {
            if (lessonId == null) {
              return _errorRoute(context, 'Lesson ID required');
            }
            return LessonDetailsScreen(lessonId: lessonId);
          },
        );

      case AppRoutes.videoLesson:
        final lessonId = settings.arguments as String?;
        return MaterialPageRoute(
          builder: (context) {
            if (lessonId == null) {
      ...
      case AppRoutes.levelCompletion:
        final args = settings.arguments as Map<String, dynamic>?;
        return MaterialPageRoute(
          builder: (_) => LevelCompletionScreen(
            levelId: args?['levelId'] ?? '',
            xpEarned: args?['xpEarned'] ?? 500,
            achievements: List<String>.from(args?['achievements'] ?? []),
          ),
        );

    // // Status route
    //   case AppRoutes.status:
    //     final isConnected = settings.arguments as bool? ?? false;
    //     return MaterialPageRoute(
    //       builder: (_) => StatusScreen(isConnected: isConnected),
    //     );

    // Default route
      default:
        return MaterialPageRoute(builder: (context) => _errorRoute(context, 'Route not found: ${settings.name}'));
    }
  }

  static Widget _errorRoute(BuildContext context, String message) {
    return Scaffold(
